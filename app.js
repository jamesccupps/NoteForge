...
const sanitizeHTML = html => {
  ...
  if (window.DOMPurify) {
    return window.DOMPurify.sanitize(html, {
      ...
      FORBID_ATTR: ["onerror", "onload", "onclick", "onmouseover", "onfocus", "onblur", "onchange", "onsubmit", "onkeydown", "onkeyup", "onkeypress", "onmousedown", "onmouseup"],
...
function NoteForge() {
  ...
  const insertLink = () => {
    ...
    if (url) {
      ...
      const text = escHtml(sel.toString() || url);
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    n: "trash",
    s: 20
  }), " Trash"), !trashPages.length ? /*#__PURE__*/React.createElement("div", {
    style: {
      color: "var(--text-muted)",
      padding: 48,
      textAlign: "center"
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      n: "lock",
      s: 13
    }), " Set Password")), hasElectronCrypto() && found.item.locked && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
      className: "nf-ctx-sep"
    }), /*#__PURE__*/React.createElement("div", {
      className: "nf-ctx-item",
      onClick: () => {
